...
// Importando os Módulos (Abas) da pasta 'tabs'
...
interface Props { isOpen: boolean; onClose: () => void; equipamento: any; }
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[2000] flex justify-end animate-fadeIn">
      <div className="w-full max-w-4xl bg-white h-full shadow-2xl flex flex-col animate-slideLeft">
        ...
        {/* INJEÇÃO DAS ABAS COMPONENTIZADAS */}
...
// Sub-componente de Botão (Para manter o arquivo principal limpo)
